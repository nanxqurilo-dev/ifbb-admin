  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-white p-6">
      <div className="max-w-7xl mx-auto">
        {/* Status Messages */}
        {(error || success) && (
          <div className={`mb-6 p-4 rounded ${error ? 'bg-red-50 border border-red-200' : 'bg-emerald-50 border border-emerald-200'}`}>
          ...
          <div className="bg-white rounded shadow-lg overflow-hidden">
            ...
            <div className="p-6">
              ...
              <div
                ...
                className={`relative rounded border-3 border-dashed p-8 transition-all duration-200 ${
                  dragActive 
              ...
              >
                ...
                <div className="flex flex-col items-center text-center">
                  ...
                  <div className="mt-6 flex flex-wrap gap-3 justify-center">
                    <button
                      ...
                      className="inline-flex items-center gap-2 px-5 py-3 rounded bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-medium hover:from-indigo-700 hover:to-purple-700 shadow-lg hover:shadow-xl transition-all"
                    >
                    ...
                    <button
                      ...
                      className={`px-5 py-3 rounded font-medium ${
                ...
                {dragActive && (
                  <div className="absolute inset-0 pointer-events-none flex items-center justify-center bg-white/90 backdrop-blur-sm rounded">
                    <div className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-6 py-4 rounded shadow-2xl animate-pulse">
                      <div className="flex items-center gap-3">
              ...
              {files.length > 0 && (
                <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="bg-gradient-to-br from-indigo-50 to-indigo-100 rounded p-4">
                  ...
                  <div className="bg-gradient-to-br from-emerald-50 to-emerald-100 rounded p-4">
                  ...
                  <div className="bg-gradient-to-br from-slate-50 to-slate-100 rounded p-4">
                ...
                <div className="mt-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-h-[400px] overflow-y-auto p-2">
                    {files.map((f, i) => (
                      <div 
                        key={f.id} 
                        className={`bg-white border rounded p-4 flex flex-col transition-all hover:shadow-lg ${
                          f.primary ? 'border-indigo-500 ring-2 ring-indigo-500/20' : 'border-slate-200'
                        }`}
                      >
                        <div className="relative w-full h-40 rounded overflow-hidden bg-gradient-to-br from-slate-100 to-slate-50 flex items-center justify-center">
                          <img 
                            src={f.url} 
                            alt={`preview-${i}`} 
                        ...
                        <div className="mt-4 flex gap-2">
                          ...
                          <button
                            ...
                            className="px-3 py-2 rounded border border-red-200 text-red-600 hover:bg-red-50 text-sm font-medium transition"
                          >
                            Remove
                          </button>
                        </div>
                ...
                <>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-h-[600px] overflow-y-auto p-2">
                    {uploadedImages.map((image) => (
                      <div 
                        key={image._id} 
                        className="bg-gradient-to-br from-slate-50 to-white border border-slate-200 rounded p-4 hover:shadow-lg transition-all"
                      >
                        <div 
                          className="relative w-full h-48 rounded overflow-hidden bg-slate-100 mb-4 cursor-pointer"
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="flex gap-2">
                            ...
                            <button
                              ...
                              className="px-3 py-2 rounded bg-red-50 hover:bg-red-100 text-red-600 text-sm font-medium transition"
                            >
                              Delete
                            </button>
                          </div>
